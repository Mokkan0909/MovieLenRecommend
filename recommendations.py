...
persons = ['Lisa Rose', 'Gene Seymour', 'Michael Phillips', 'Claudia Puig', 'Mick LaSalle', 'Jack Matthews', 'Toby']
titles = ['Lady in the Water', 'Snakes on a Plane', 'Just My Luck', 'Superman returns', 'You, Me and Dupree', 'The Night Listener']
...
#    #映画のタイトルを得る
#    movies = {}
#    for line in open(path + '//movies.csv', errors='ignore'):
...
prefs = loadMovieLens()
t1 = getRecommendations(prefs, '87')[0:30]
...
#    print(tl)
#    print(topMatches(movies, tl))
#    print(getRecommendations(movies, tl))
